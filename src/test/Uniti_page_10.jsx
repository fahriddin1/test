            ...
            <div className="container containers">
                <div className="tests">
                    <div className="test__name">
                        <h2>diqat<samp className='red'>t</samp> <span className='blue'>savol<span className='red'>!</span></span> (10)</h2>
                    </div>
                    ...
                    <div className="botoom__btn">
                        <a className='botton' href="Uniti_page_9">orqaga</a>
                        <a className='botton btm' href="#">kegingisi</a>
                    </div>
                </div>
            </div>
        </React.Fragment>
