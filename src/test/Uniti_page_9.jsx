              ...
              <div></div>
                ...
                <div className="tests">
                    ...
                    <button  type="button" class="buttonq">
                              {/* <a href="/Uniti_page_8" className='button-top'>orqaga</a> */}
                              <NavLink to={"Uniti_page_8"} className='button-top'  >orqaga</NavLink>
                              <div  class="button-bottom"></div>
                              <div  class="button-base"></div>
                        </button> 
                      {/* <<<<<<<<<1>>>>>>>>> */}
                         <button  type="button" class="buttone">
                              {/* <a href="/Uniti_page_10" className='button-top'>kengisi</a> */}
                              <NavLink to={"Uniti_page_10"} className='button-top'  >kengisi</NavLink>
                              <div  class="button-bottom"></div>
                              <div  class="button-base"></div>
                        </button>
