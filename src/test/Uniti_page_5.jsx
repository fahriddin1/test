            ...
            <div className="container containers">
                <div className="tests">
                    ...
                    {/* <div className="botoom__btn">
                        <a className='botton' href="/Uniti_page_4">orqaga</a>
                        <a className='botton btm' href="/Uniti_page_6">kegingisi</a>
                    </div> */}

                <button  type="button" class="buttonq">
                              {/* <a href="/Uniti_page_4" className='button-top'>orqaga</a> */}
                              <NavLink to={"Uniti_page_4"} className='button-top'  >orqaga</NavLink>
                              <div  class="button-bottom"></div>
                              <div  class="button-base"></div>
                        </button> 
                      {/* <<<<<<<<<1>>>>>>>>> */}
                         <button  type="button" class="buttone">
                              {/* <a href="/Uniti_page_6" className='button-top'>kengisi</a> */}
                              <NavLink to={"Uniti_page_6"} className='button-top'  >kengisi</NavLink>
                              <div  class="button-bottom"></div>
                              <div  class="button-base"></div>
                        </button>  
