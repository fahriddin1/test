            ...
            <div className="container containers">
                <div className="tests">
                    <div className="test__name">
                        <h2>diqat<samp className='red'>t</samp> <span className='blue'>savol<span className='red'>!</span></span> (3)</h2>
                    </div>
                    ...
                    <div className="botoom__btn">
                        ...
                        <a className='botton btm' href="/Uniti_page_4">kegingisi</a>
                    </div>
